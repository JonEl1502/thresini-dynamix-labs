...
export const metadata: Metadata = {
  ...
  description:
    "Request a quote from ThreSiNi Dynamix Labs. Websites, mobile applications and SaaS products for businesses worldwide.",
};

const FACTS = [
  { key: "Where we work", value: "Worldwide, remote by default" },
