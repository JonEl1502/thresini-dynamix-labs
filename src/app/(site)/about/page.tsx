...
export const metadata: Metadata = {
  title: "About",
  description:
    "ThreSiNi Dynamix Labs builds websites, mobile applications and SaaS products for businesses worldwide.",
};
  ...
  return (
    <>
      <PageHero
        ...
        lede="We build websites, mobile applications and SaaS products for businesses wherever they trade — and we keep running them after launch, which is the part that decides whether software was worth building."
        aside={
          <OrbitMark
            variant="full"
            palette="system"
      ...
      <Section id="who" index="01" label="Who we are">
        ...
        <div className={i.prose}>
          <p>
            ...
            for clients wherever they are. We build three
