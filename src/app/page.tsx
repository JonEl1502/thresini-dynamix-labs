          ...
          <div className={s.heroInner}>
            <div className={s.heroCopy}>
              ...
              <p className={`lede ${s.heroLede} reveal`} style={delay(3.15)}>
                We design, build and ship software for businesses in the USA, the
                UK and Australia — then keep running it afterwards. Tell us what
                you need built and you get a fixed price against a written scope.
              </p>
          ...
          <div className={s.contactAside}>
            ...
            <div className={s.contactFacts}>
              <div className={s.contactFact}>
                <span className={s.contactFactKey}>Territories</span>
                <span>USA · United Kingdom · Australia</span>
              </div>
              <div className={s.contactFact}>
